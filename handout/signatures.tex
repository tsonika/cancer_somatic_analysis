...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{!PATH/numberofsignatures.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{!PATH/alexandrov_nature.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{!PATH/mutational_processes.png}
